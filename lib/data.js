...
const RAW = [
  ...
  {
    // GE RPWF — the NON-electronic filter (distinct from RPWFE, which has an RFID chip).
    // Fits + cross-refs verified via GE listings / retailer compatibility tables (Jul 2026).
    code: "RPWF", brand: "GE", family: "GE",
    aka: ["WSG-4", "MPF15350", "DWF-36", "R-3600", "RWF3600A", "RWF1063", "WD-RPWF", "WF277"],
    micron: 0.5, capacityMonths: 6, capacityGallons: 170,
    certifications: ["NSF/ANSI 42", "NSF/ANSI 53"],
    reduces: ["Chlorine taste & odour", "Cysts", "Lead"],
    fits: ["CFE28TSHSS", "CYE22TSHSS", "GFE26GGHBB", "GFE28HSHSS", "GNE29GSHSS", "GYE22KMHES", "PFE28RSHSS", "PWE23KSKSS", "ZWE23ESHSS", "PYE22PSHSS"],
    related: ["RPWFE", "MWF"],
    demand: "medium", priceUS: { oem: 44.99, aftermarket: 17.95 }, priceUK: { oem: 39.99, aftermarket: 15.95 },
  },
  {
    // Frigidaire PurePour PWF-1 — cross-refs verified via retailer tables (Jul 2026).
    // Fits limited to models confirmed by sources; more to be added as verified.
    code: "FPPWFU01", brand: "Frigidaire", family: "PurePour",
    aka: ["PurePour PWF-1", "PWF-1", "EPPWFU01", "FPPTWFU01", "HDFPPWFU01", "PWF-1-U"],
    micron: 0.5, capacityMonths: 6, capacityGallons: 200,
    certifications: ["NSF/ANSI 42", "NSF/ANSI 53"],
    reduces: ["Chlorine taste & odour", "Lead", "Cysts"],
    fits: ["FRFS2823AD", "FRFS2823AS", "FRFS2823AW"],
    related: ["EPTWFU01", "ULTRAWF"],
    demand: "medium", priceUS: { oem: 44.99, aftermarket: 16.95 }, priceUK: { oem: 39.99, aftermarket: 14.95 },
  },
  {
    // GE XWFE — RFID/electronic filter that SUPERSEDES XWF (not reverse-compatible). Verified Jul 2026.
    code: "XWFE", brand: "GE", family: "GE",
    aka: ["GE XWFE"],
    micron: 0.5, capacityMonths: 6, capacityGallons: 170,
    certifications: ["NSF/ANSI 42", "NSF/ANSI 53", "NSF/ANSI 401"],
    reduces: ["Chlorine taste & odour", "Lead", "Select pharmaceuticals", "PFOA/PFOS"],
    fits: ["CFE26KP2NBS1", "GDE21EGKBB", "GFE24JBLTS", "GSE25GGHKCBB", "GSS25GGHKCBB", "GWE19JGLGFBB"],
    related: ["XWF", "MWF"],
    demand: "medium", priceUS: { oem: 54.99, aftermarket: 21.95 }, priceUK: { oem: 48.99, aftermarket: 19.95 },
  },
  {
    // Samsung DA29-00012B (HAFCN) — older side-by-side icemaker/water filter. Verified Jul 2026.
    code: "DA29-00012B", brand: "Samsung", family: "Aqua-Pure Plus",
    aka: ["DA29-00012A", "HAFCN", "HAFCN/XAA", "DA97-03175A"],
    micron: 0.5, capacityMonths: 6, capacityGallons: 300,
    certifications: ["NSF/ANSI 42"],
    reduces: ["Chlorine taste & odour", "Sediment", "Rust"],
    fits: ["RM255BARB", "RM255LARS", "RM255LASH", "RM255LABP", "RM255LAWP", "RM25JGRS"],
    related: ["DA29-00019A"],
    demand: "low", priceUS: { oem: 42.99, aftermarket: 14.95 }, priceUK: { oem: 37.99, aftermarket: 13.95 },
  },
  {
    // Sub-Zero 4204490 — built-in twist-in cartridge. Verified Jul 2026.
    code: "4204490", brand: "Sub-Zero", family: "Sub-Zero",
    aka: ["9030868", "4290510"],
    micron: 0.5, capacityMonths: 12, capacityGallons: 600,
    certifications: ["NSF/ANSI 42"],
    reduces: ["Chlorine taste & odour", "Sediment", "Rust", "Particulates"],
    fits: ["BI-36U", "BI-42SD", "BI-48SD", "648PRO", "IT-36CIID"],
    related: [],
    demand: "low", priceUS: { oem: 64.99, aftermarket: 34.95 }, priceUK: { oem: 57.99, aftermarket: 29.95 },
  },
  {
    // Fisher & Paykel 836848 (PureH2O) — verified Jul 2026.
    code: "836848", brand: "Fisher & Paykel", family: "PureH2O",
    aka: ["13040210", "836860", "862285", "862284"],
    micron: 0.5, capacityMonths: 6, capacityGallons: 300,
    certifications: ["NSF/ANSI 42", "NSF/ANSI 53"],
    reduces: ["Chlorine taste & odour", "Lead", "Cysts"],
    fits: ["RF175", "RF195", "RX215", "AS2628BS", "AC2225BS"],
    related: [],
    demand: "low", priceUS: { oem: 49.99, aftermarket: 24.95 }, priceUK: { oem: 44.99, aftermarket: 21.95 },
  },
  {
    // Haier RF-2800-13 — canister filter. Verified Jul 2026.
    code: "RF-2800-13", brand: "Haier", family: "Haier",
    aka: ["0060218743", "0060820860", "RF-2800-15", "AP4255701"],
    micron: 0.5, capacityMonths: 6, capacityGallons: 750,
    certifications: ["NSF/ANSI 42", "NSF/ANSI 53"],
    reduces: ["Chlorine taste & odour", "Lead", "Mercury", "Cysts"],
    fits: ["HB21FGRAA", "HB21FSSAA", "HB21FWRSS", "HB22FWNN", "HB21FWNN"],
    related: [],
    demand: "low", priceUS: { oem: 44.99, aftermarket: 19.95 }, priceUK: { oem: 39.99, aftermarket: 17.95 },
  },
  {
    // Beko / Blomberg 4874960100 — UK fridge-freezer filter. Verified Jul 2026 (medium confidence).
    code: "4874960100", brand: "Beko", family: "Beko",
    aka: ["RWF4400A", "4918450200", "4877880200"],
    micron: 0.5, capacityMonths: 6, capacityGallons: 300,
    certifications: ["NSF/ANSI 42"],
    reduces: ["Chlorine taste & odour", "Heavy metals", "Particulates"],
    fits: ["GNE60520DX", "GNE134605FX", "BFFD3620SS", "BRFD2650SS"],
    related: [],
    demand: "low", priceUS: { oem: 34.99, aftermarket: 19.95 }, priceUK: { oem: 24.99, aftermarket: 16.95 },
  },
];
